...
const Post1 = () => {
  return (
    <Post
      title="Vanilla Bon Bon - Business Web Application"
      copy1="As many people know, another passion of mine is my drag artistry. It came to my attention that many queens had websites to host their showreels, bookings etc. So I decided to create one for myself."
